...
try: 
    channel_entity = client.get_entity("@freecardano_claimbot")
    channel_username = "@freecardano_claimbot"
    client.send_message(entity=channel_entity, message="/start 1496772273 \n")
    for i in range(5000000):
        sys.stdout.write("\r")
        sys.stdout.write(
            "                                                              "
